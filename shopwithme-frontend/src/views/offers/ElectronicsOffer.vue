<template>
  <div class="electronics-promo">
    <div class="banner">
      <div class="banner-text">
        <h1>PROMOCJA NA ELEKTRONIKĘ</h1>
        <p class="subtitle">Rozrywka na najwyższym poziomie – teraz taniej!</p>
        <p>Telewizory 4K, słuchawki i konsole do gier w wyjątkowych cenach.</p>
        <p>
          Zamień swój salon w centrum multimedialne dzięki naszym promocjom.
        </p>
        <p class="call-to-action">Odkryj ofertę RTV</p>
      </div>
      <img
        src="https://placehold.co/600x400"
        alt="Promocja na elektronikę"
        class="banner-image"
      />
    </div>
...
export default class WorkEnjoyOffer extends Vue {
  ...
  async mounted() {
    try {
      const productIds = [58, 61, 67, 69, 76];
